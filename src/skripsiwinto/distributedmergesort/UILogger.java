 ...
 */
public class UILogger extends SwingWorker<Void, String>{

    private String message;
    private TampilanServer form;
    private boolean tulis = false;
    private Path file;
    private int[] arr;
    
    
    UILogger(TampilanServer form, String message, Path file, boolean tulis){
    ...
    UILogger(TampilanServer form, int[] arr, Path file, boolean tulis){
        this.message = message;
        this.form = form;
        this.tulis = tulis;
        this.file = file;
